...
class NotificationService:
    ...
    def _get_channel_config(self, channel: NotificationChannel) -> Dict:
        """
        获取渠道配置

        配置统一从NotificationChannel.config字段获取
        """
    ...
    async def send_test_notification(self, channel_id: int) -> Dict:
        ...
        result = await sender.send(config, title, content)
        return result
