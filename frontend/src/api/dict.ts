...
export function getDictTypes(params?: {
  ...
  return request.get<any, PaginatedResponse<DictType>>('/dict/types', { params })
}
...
export function getDictType(typeId: number) {
  return request.get<any, DictType>(`/dict/types/${typeId}`)
}
...
export function createDictType(data: DictTypeCreateParams) {
  return request.post<any, DictType>('/dict/types', data)
}
...
export function updateDictType(typeId: number, data: DictTypeUpdateParams) {
  return request.put<any, DictType>(`/dict/types/${typeId}`, data)
}
...
export function deleteDictType(typeId: number) {
  return request.delete<any, void>(`/dict/types/${typeId}`)
}
...
export function getDictItemsByTypeCode(code: string) {
  return request.get<any, DictItem[]>(`/dict/types/${code}/items`)
}
...
export function getDictItems(params?: {
  ...
  return request.get<any, PaginatedResponse<DictItem>>('/dict/items', { params })
}
...
export function getDictItem(itemId: number) {
  return request.get<any, DictItem>(`/dict/items/${itemId}`)
}
...
export function createDictItem(data: DictItemCreateParams) {
  return request.post<any, DictItem>('/dict/items', data)
}
...
export function updateDictItem(itemId: number, data: DictItemUpdateParams) {
  return request.put<any, DictItem>(`/dict/items/${itemId}`, data)
}
...
export function deleteDictItem(itemId: number) {
  return request.delete<any, void>(`/dict/items/${itemId}`)
}
...
export function getDictItemsTree(typeId: number) {
  return request.get<any, DictItem[]>('/dict/items/tree', { params: { type_id: typeId } })
}