...
export interface AccountingRealtimePnl {
    floating_pnl: number;
...
export interface AccountingIndustryDistribution {
    industry: string;
    weight: number;
    value: number;
    position_count: number;
...
export interface AccountingTopHolding {
    symbol: string;
    name: string;
    weight: number;
    market_value: number;
...
export interface AccountingRiskExposure {
...
export interface AccountingPositionStructure {
    industry_distribution: AccountingIndustryDistribution[];
    sector_concentration: Record<string, number>;
    risk_exposure: AccountingRiskExposure;
    position_count: number;
    top_holdings: AccountingTopHolding[];
}

export interface AccountingData {
    realtime_pnl: AccountingRealtimePnl;
    structure: AccountingPositionStructure;
}
